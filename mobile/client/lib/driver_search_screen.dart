...
class _DriverSearchScreenState extends State<DriverSearchScreen>
  ...
  void initState() {
    ...
    // Navigate to driver en route screen after 3 seconds
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
            builder: (_) => DriverEnRouteScreen(
              ...
              selectedPayment: null, // Will be passed from ride selection in real app
              selectedPromo: null, // Will be passed from ride selection in real app
            ),
          ),
        );
      }
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            child: _buildStatusPanel(size, clampDouble),
          ),
        ],
      ),
    );
  ...
  Widget _buildStatusPanel(Size size, Function clampDouble) {
    final horizontalPadding = clampDouble(size.width * 0.05, 16, 24);
